    ...
    public static TrailData fromConfig(ConfigurationSection cfg) {
        ...
        switch (typeName) {
            case "color_transition":
                ...
                OrdinaryColor start =
                        new OrdinaryColor(
                                cfg.getInt("r", 0), cfg.getInt("g", 0), cfg.getInt("b", 0));
                OrdinaryColor end =
                        new OrdinaryColor(
                                cfg.getInt("r2", 0), cfg.getInt("g2", 0), cfg.getInt("b2", 0));
            ...
            case "ordinary_color":
                ...
                obj = new OrdinaryColor(cfg.getInt("r", 0), cfg.getInt("g", 0), cfg.getInt("b", 0));
                break;
            case "material":
                type = DataType.MATERIAL;
                obj = Registry.MATERIAL.get(NamespacedKey.fromString(cfg.getString("material")));
                break;
            default:
                return new TrailData();
        }
